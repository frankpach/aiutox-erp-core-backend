...
def generate_model(name: str, output_dir: Optional[Path] = None) -> Path:
    ...
    console.print(f"[green]✓ Generated model: {output_file}[/green]")
    return output_file
...
def generate_service(name: str, output_dir: Optional[Path] = None) -> Path:
    ...
    console.print(f"[green]✓ Generated service: {output_file}[/green]")
    return output_file
...
def generate_repository(name: str, output_dir: Optional[Path] = None) -> Path:
    ...
    console.print(f"[green]✓ Generated repository: {output_file}[/green]")
    return output_file
...
def generate_router(name: str, output_dir: Optional[Path] = None) -> Path:
    ...
    console.print(f"[green]✓ Generated router: {output_file}[/green]")
    return output_file
...
def generate_module(name: str, entities: list[str] = None) -> dict[str, Path]:
    ...
    console.print(f"\n[green]✓ Generated complete module '{name}' with {len(entities)} entity(ies)[/green]")
...
def generate_seeder(name: str, output_dir: Optional[Path] = None) -> Path:
    ...
    console.print(f"[green]✓ Generated seeder: {output_file}[/green]")
    return output_file
