...
class InventoryRepository:
  ...
  def list_warehouses(self, tenant_id: UUID, skip: int = 0, limit: int = 100) -> list[Warehouse]:
    return (
  ...
  def list_stock_moves(
    ...
    return query.order_by(StockMove.created_at.desc()).offset(skip).limit(limit).all()
